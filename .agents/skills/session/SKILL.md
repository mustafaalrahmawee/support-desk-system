...
Für QA-Regeln, Fehlerklassen und technische Arbeitsregeln gilt `AGENTS.md`.
...
3. Der Subagent arbeitet nach `.agents/skills/backend-qa/SKILL.md`
...
Bei Fehlern gelten die Nachbesserungsregeln aus `AGENTS.md`.
...
7. Subagent `frontend-qa` für den einzelnen UC aufrufen, um einen manuellen QA-Plan zu erzeugen
8. Stoppen und auf dokumentierte Benutzerergebnisse warten
9. Benutzerergebnisse auswerten
10. Falls nötig nachbessern — Fehlerklassen und Nachbesserungsregeln gelten aus `AGENTS.md`
