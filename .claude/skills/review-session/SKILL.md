...
Für Review-Regeln und Subagenten-Verhalten gilt `CLAUDE.md`.
...
Der Subagent arbeitet nach `.claude/skills/backend-code-review/SKILL.md`.
...
Der Subagent arbeitet nach `.claude/skills/frontend-code-review/SKILL.md`.
...
- **Refactoring-Vorschlag für Claude Code:** konkrete Korrekturschritte, falls Findings vorhanden
